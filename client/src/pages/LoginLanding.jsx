...
const LoginLanding = () => {
  ...
  const portalOptions = [
    ...
    },
    {
      ...
      description: "Access your personal information, leave requests, and other employee-specific features.",
      icon: UserIcon
    },
  ]
            ...
            {portalOptions.map((portal) => (
              ...
              >
                <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                  ...
                  <ArrowRightIcon className="h-4 w-4 text-slate-400 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all duration-300" />
                  <p className="text-slate-500 text-sm">{portal.description}</p>
                </div>
              </Link>
            ))}
          </div>
